    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            <p className="text-slate-400 mb-12">
                Building software and AI systems since 2019.
            </p>
            ...
            <div className="flex flex-col gap-5">
                ...
                <Experience
                    ...
                    description={[
                        '• Laid the groundwork for a future LLM project that will organize a file archive containing millions of miscellaneous files, allowing for fast file lookup based on LLM-generated tags.',
                ...
                <Experience
                    ...
                    description="Worked events with 100s of prospective students and their families. Communicated with Computer Science Department heads on general student opinions and concerns."
                />
                <Experience
